...
class LINE:
  ...
  def login(self, mail=None, passwd=None, cert=None, token=None, qr=False, callback=None):
    ...
    self._headers = {'X-Line-Application': 'DESKTOPMAC 10.13.2-YOSEMITE-x64    MAC 5.5.1', 'X-Line-Access': self.authToken, 'User-Agent': 'Mozilla/57.0.4'}
    self.cert = self.Talk.cert
    self._headers = {
              'X-Line-Application': 'DESKTOPMAC 10.13.2-YOSEMITE-x64    MAC 5.5.1', 
