...
cl = LINETCR.LINE()
cl.login(token="EqTEzycbAYaCN8M8P7Zc.KBtylGF7T07g2h8DyG87Ja.LjWTm+j9brDecf9GhocpIZDcOn/6KxQ65pT1zbwVAkY=")

ki = LINETCR.LINE()
ki.login(token="Eq9ZiVWLTzYQrFOtLyL8.yeeFkYzvwhoWJ52woLDjQa.TEkRLbCeD5o8h7iQxKDxw05SHUAx9f0239pUdwmyZsc=")

kk = LINETCR.LINE()
kk.login(token="Eq140BnOnrjardWSKeka.PofXftRniBZHiiLLYC37sG.E7rqcN4GUE8TtrPQHGreXL68/TVRZjbcUacljdnWi1Q=")

kc = LINETCR.LINE()
kc.login(token="EqdYIqzvbUSchtvrh1e3.AI9R5QXoLIki841eZJRGWW.1+qbqDhpqjoNRf1rqP8uux0pNkHk/RWqAlHm60KEFnc=")

ks = LINETCR.LINE()
ks.login(token="EqufPUEGBuxWR2VVIQOb.fJ/2OzZsyqO7vs6/M3oIQW.t4qm1JkcZmkM06c62I7NnqR19gZd0tVh3pTx+C7IFrA=")

ka = LINETCR.LINE()
ka.login(token="Eqsstw0tcrJE6U2SGy1f.w2y3st77l8p+Bfx9XcVvtW.9ZrsNJ6rZgkrBXKG10OPiJqgl0/jWmnfRMtz2hTpBN4=")

kb = LINETCR.LINE()
kb.login(token="EqLaWUVtvWNeTWBLh8cc.dmwV+8AvfCg9qISHOhivVa.kJdyL8NrEvoK5OtwFFpWrWIkcw+thTu6FyCI/OYgip0=")

ko = LINETCR.LINE()
ko.login(token="Eq7UxJfOSY0FHTMQrHzf.bMxsVktNlf4/LlMU1msQZW.AHpw7nYxOvSi+97irKfMkaCiv6t0o4DZaVX2GgIyOxE=")

ke = LINETCR.LINE()
ke.login(token="Eq972I44RgxpLL3chC63.o2XXqY54uxyx4WHdWleLeW.z1fkmH0vqyVE5aGpUkOagPjOnt6volg+hGVXsWvqYyk=")

ku = LINETCR.LINE()
ku.login(token="EqtZsBwCPHMefbdQxWH4.0aPixyJFVtPGnatN+0kpja.vZFWL+km5u5SSczAM7fseCfDZt1kbJVTsXRCE4/KFz4=")
...
Selfbot by:F҉bL҉ 􀌂􀄠􀌂􀄠 V҉ic҉ky҉҉ ᵗᵉᵅᵐ ᵇᵒᵗ

􀔃􀅕☯️☣️ Selfbot command ☣️☯️
...
➺Radiance bye
 ...
 support by F҉bL҉ 􀌂􀄠􀌂􀄠 V҉ic҉ky҉҉
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,"u8275fa776e123d956a0ca89d44b6edc0","u8f45b3fbc42c1f469982f73ae12912a6","u8426bcab8249b98cd453358f890f7e31","u17067e0125bf4c8e1dd6fc32c6c1c1aa","ud4595236de7bdc4898d247eace1555e0","u6ad271a98986426f64f57d4a81f363a1","uc8617c362935b1f76c413d917293817c","u832484b5ec76b672f289a900155d6b70","u0421978de2f365346bfe706bf0e8744e"]
