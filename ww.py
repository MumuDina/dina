...
helpMessage= """ 
 ...
 ➣  Spam gift
  ...
  ᵃⁿᵍᵉˡ ᵇᵒᵗ ℬℽ F༘༘̈́̈́B༘̈́̈́L༘̈́̈́  ̈́V༘̈́̈́IC༘̈́̈́K༘̈́̈́Ÿ༘́ •в̰̰̈́ä̰̰́т̰̰̈́❍ṵ̰̰̈́s̰̰ä̰̰̰́ḭ̰̰̈́•
"""
KAC=[cl]
...
owner = ["u91b4d82e07fbb74ec6d87f1d620f3b8c"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    "lang":"JP",
    "comment":"AutoLike by F༘༘̈́̈́B༘̈́̈́L༘̈́̈́  ̈́V༘̈́̈́IC༘̈́̈́K༘̈́̈́Ÿ༘́ •в̰̰̈́ä̰̰́т̰̰̈́❍ṵ̰̰̈́s̰̰ä̰̰̰́ḭ̰̰̈́• ",
...
#==================================================
            ...
            elif "Angel1 rename" in msg.text:
              if msg.from_ in owner:
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    cl.updateProfile(profile)
                    cl.sendText(msg.to,"change name: "+string+"\nsucces")
            elif "Angel2 rename:" in msg.text:
              if msg.from_ in owner:
            ...
            elif "Angel3 rename:" in msg.text:
              if msg.from_ in owner:
            ...
            elif "Angel4 rename:" in msg.text:
              if msg.from_ in owner:
            ...
            elif "Angel5 rename:" in msg.text:
              if msg.from_ in owner:
            ...
            elif "Angel6 rename:" in msg.text:
              if msg.from_ in owner:
...
#==================================================================
              ...
              if msg.from_ in admin:
                ...
                msg.contentMetadata = {'mid': 'u4a361586c55ac4ef218a0a9b78b2f1b3'}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Itu Creator saya yg muanis dan ehem 😄😄😄 ")
              ...
              if msg.from_ in admin:
                ...
                if msg.from_ in owner:
                    ...
                    cl.sendText(msg.to,"owner permission required.")
#==========================================================
            elif 'angel mid' in msg.text.lower():
               if msg.from_ in admin:
              ...
              if msg.from_ in admin:
	           ...
	           if msg.from_ in admin:
                ...
                try:
                    ...
                    cl.sendText(msg.to, "Backup Angel Sukses")
                except Exception as e:
                    cl.sendText(msg.to, str (e))

#===============================================
            elif msg.text in ["Dsp","Debug speed"]:
              if msg.from_ in admin:
...
#========================================
                ...
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["Angel6 backup run"]:
                if msg.from_ in admin:
...
#=================================================
                ...
                if msg.from_ in admin:
                        try:
                            ...
                            print e
            elif "Angel6 backup" in msg.text:
                if msg.from_ in admin:
                        try:
...
#========================================
              ...
              if msg.from_ in admin:
					...
					G.preventJoinByTicket = True
					cl.updateGroup(G)
					print "Angel dah masuk W⃟   I⃟   B⃟   "
					G.preventJoinByTicket(G)
					cl.updateGroup(G)
#=====================================================================================
          
            elif msg.text in ["Bye all group"]:
              if msg.from_ in admin:
				gid = cl.getGroupIdsJoined()
				for i in gid:
					cl.leaveGroup(i)
